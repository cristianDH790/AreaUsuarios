                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="modal-defaultagregar">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form
                                                                action="<?php print RUTA;?>AdminControlador/AgregarExpositor"
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="mb-1 row">
                                                                        <div class=" col-sm-6 mb-3 mb-sm-0"><label
                                                                                for="nombreInstitucion3"
                                                                                class="col-form-label">DNI:</label>
                                                                            <input type="number" value="" name="dni"
                                                                                class="form-control"
                                                                    ...
                                                                    <div class="mb-1 row">
                                                                        ...
                                                                        <div class=" col-sm-6 mb-3 mb-sm-0">
                                                                            <input type="text" 
                                                                                ...
                                                                                name="IdExpositores"  class="form-control d-none">
                                                                        </div>
