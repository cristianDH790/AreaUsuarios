...
<div class="content-wrapper">
    ...
    <section class="content">
                                            ...
                                            <td>
                                                                ...
                                                                <div class="mb-1 row">
                                                                    <div class=" col-sm-6 mb-3 mb-sm-0"><label
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            name="textofirmadirector3"
                                                                            class="form-control">
                                                                    </div>
                                                                    <div class=" col-sm-6 mb-2 mb-sm-0"><label
                                                                            for="vacio" class="col-form-label"></label>
                                                                        <input invisible type="hidden" value=""
                                                ...
                                                <div class="modal fade"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form
                                                                action="<?php print RUTA;?>AdminControlador/EditarConvenio/"
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="mb-1 row">
                                                                        ...
                                                                        <div class="col-sm-5 mb-2 mb-sm-0">
                                                                            <label for="directorAcademico3"
                                                                                class="col-form-label">Vista previa: <a
                                                                                    href="#" id="newRemoveImageLink8"
        ...
        <div class="modal fade" id="modal-defaultagregar">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?php print RUTA;?>AdminControlador/AgregarConvenio" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class=" col-sm-6 mb-2 mb-sm-0"><label for="vacio" class="col-form-label"></label>
                                    <input invisible type="hidden"
                                        value="<?php //print $datos['dataTable'][$i]['Correo']; ?>" name="vacio"
                                        class="form-control">
                                </div>
