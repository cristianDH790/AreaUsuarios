                                            ...
                                            <td>
                                                ...
                                                <div class="modal  fade "
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form
                                                                action="<?php print RUTA;?>AdminControlador/EditarUsuario/"
                                                                method="POST">
                                                                <div class="modal-header">
                                                                    ...
                                                                    <div class="mb-2 row">
                                                                        ...
                                                                        if ($datos["dataTable"][$i]["IdEstado"] == "2") {
                                                                            ?>
                                                                                ...
                                                                                <option selected value="2">INACTIVO
                                                                                </option>
                                                                                <?php
                                                                         }
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-2">
                                <label for="correo3" class="col-form-label">Correo
                                    Electronico:</label>
                                <input type="email" value="<?php //print $datos['dataTable'][$i]['Correo'];?>"
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="Estado3" class="col-form-label">Estado:</label>
                            ...
                            <div class="mb-2 row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="telefono3" class="col-form-label">Telefono:</label>
                                    <input type="number" name="telefono3" class="form-control">
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <label for="contrasena3" class="col-form-label">Contraseña:</label>
